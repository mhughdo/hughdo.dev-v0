...
export default css`
  ...
  @font-face {
    ...
    font-weight: normal;
    font-style: normal;
    src: url(${Jost400Book}) format('woff2'), url(${Jost400BookTTF}) format('woff'),
      url(${Jost400BookWOFF}) format('truetype');
  }
  @font-face {
    font-family: Jost;
    font-weight: normal;
  ...
  @font-face {
    ...
    font-weight: 500;
    font-style: normal;
    src: url(${Jost500Medium}) format('woff2'), url(${Jost500MediumWOFF}) format('woff'),
      url(${Jost500MediumTTF}) format('truetype');
  }
  @font-face {
    font-family: Jost;
    font-weight: 500;
  ...
  @font-face {
    ...
    font-weight: 700;
    font-style: normal;
    src: url(${Jost700Bold}) format('woff2'), url(${Jost700BoldWOFF}) format('woff'),
      url(${Jost700BoldTTF}) format('truetype');
  }
